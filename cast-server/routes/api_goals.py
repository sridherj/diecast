...
from taskos.services.goal_service import (
    create_goal, update_status as change_status, update_phase as set_phase, toggle_focus,
)
from taskos.services import agent_service, goal_service, task_service
from taskos.services.suggestion_service import approve_suggestion, decline_suggestion
from taskos.goal_detector.runner import run_detector, get_detector_status
...
async def get_phase_tab(request: Request, slug: str, phase: str):
    ...
    from taskos.config import PHASES, PHASE_ARTIFACTS
    from taskos.utils.file_utils import extract_authorship
