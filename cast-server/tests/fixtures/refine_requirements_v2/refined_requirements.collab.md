...
|----|-------------|-------|
| FR-001 | The refined output shall lead with WHAT content; HOW content shall be confined to a clearly-marked, non-binding "Directional ideas" section | US1 |
...
- Changes to the exploration pipeline (cast-explore) itself.
