---
name: cast-ui-test-about
description: >
  Diecast UI e2e: about screen. Drives /about in Chromium via Playwright
  (delegated to runner.py) — static content + zero JS console errors.
tags:
  - test
  - ui
type: test
...
Drive the `about` page of the Diecast UI in a Chromium browser via Playwright,
...
{
  "contract_version": "2",
  "agent_name": "cast-ui-test-about",
  "task_title": "UI e2e: about screen",
...
- Asserts `/about` loads and renders static content. Zero JS console errors is the
  primary success signal; runner.py enforces the policy.
