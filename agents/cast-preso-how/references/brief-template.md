...
> Loaded by `taskos-preso-how` at Step 5 (brief creation).
...
**SJ decides:** {What specifically differs between A and B}
...
- **Approaches Considered:** ALWAYS include 2-3 distinct approaches, even if obviously losing approaches. The evidence of consideration matters for SJ to trust the selection. Mark winner with "← SELECTED."
